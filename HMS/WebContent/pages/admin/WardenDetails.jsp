...
<title>Home | Admin |Warden_Details</title>
	...
	<main role="main" style="padding-top: 50px;">
		...
		<img src="3.jpg" style= "width:400;height:150;margin-top:-100px;">
			<div align="center">
				...
				text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;">ALL WARDEN DETAILS IS HERE</h3>
...
<br/>
			...
			<div class="form-group">
				...
				<form action="/HMS/StudentInfoServlet" method="get">
					...
					<label for="name">Choose User_Name</label> 
					<select name="name">
